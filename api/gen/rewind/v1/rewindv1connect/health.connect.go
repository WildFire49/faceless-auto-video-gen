...
const (
	...
	HealthServiceName = "rewind.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/rewind.v1.HealthService/Check"
)

// HealthServiceClient is a client for the rewind.v1.HealthService service.
...
// NewHealthServiceClient constructs a client for the rewind.v1.HealthService service. By default,
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_rewind_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls rewind.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the rewind.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/rewind.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("rewind.v1.HealthService.Check is not implemented"))
}
